...
import in.bushansirgur.billingsoftware.filters.JwtRequestFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http)  throws Exception {
        http.cors(Customizer.withDefaults())
                ...
                .sessionManagement(session -> session.maximumSessions(SessionCreationPolicy.STATELESS.ordinal()))
